...
def main():
    ...
    transforms.RandomRotation(10),      # 10度までのランダム回転
    #transforms.RandomResizedCrop(224, scale=(0.8, 1.0)),
    transforms.ToTensor(),
    transforms.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225]),  # 正規化
    transforms.RandomErasing(p=0.5, scale=(0.02, 0.33), ratio=(0.3, 3.3)),#マスク
    transforms.GaussianBlur(kernel_size=(5, 9), sigma=(0.1, 5))#ぼかし
    ])
